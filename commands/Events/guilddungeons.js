...
module.exports = {
    name: 'guilddungeons',
    aliases: ['gd', 'guildd'],
    usage: 'guilddungeons <guild>',
    tldr: 'Gets the total maniacs dungeons exp for all guild members',
    description: 'Scans a guild, checking all members total catacombs experience',
    modOnly: true,
